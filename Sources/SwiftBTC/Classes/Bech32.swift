...
public enum Bech32 {
  ...
  private static let generator = [0x3b6a_57b2, 0x2650_8e6d, 0x1ea1_19fa, 0x3d42_33dd, 0x2a14_62b3]
  ...
  private static func createChecksum(humanReadablePart: String, data: Data) -> Data {
    let values =
      expandHumanReadablePart(humanReadablePart) + data + Data(Array(repeating: UInt8(0), count: 6))
  ...
  public static func decode(_ bechString: String, limit: Bool = true) -> (
    humanReadablePart: String, data: Data
  )? {
