...
final class BitcoinURITests: XCTestCase {
  ...
  let tests: [(String, String, Satoshi?, String?, String?)] = [
    ...
    (
      "bitcoin:mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p?message=Luke-Jr",
      "mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p", nil, "Luke-Jr", nil
    ),
    (
      "bitcoin:mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p?amount=20.3&message=Luke-Jr",
      "mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p", 2_030_000_000, "Luke-Jr", nil
    ),
    (
      "bitcoin:mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p?amount=50&message=Donation%20for%20project%20xyz",
      "mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p", 5_000_000_000, "Donation for project xyz", nil
    ),
    (
      ...
      "mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p", nil, nil,
  ...
  func testBitcoinURI() {
    for (uriString, address, amount, memo, lightningFallback) in tests {
      ...
      XCTAssertEqual(
        BitcoinURI(
          address: address, amount: amount, memo: memo, lightningFallback: lightningFallback)?
          .uriString, uriString)
    }
  }
  ...
  func testAddressOrURI() {
    let tests: [(String, String, Satoshi?, String?, String?)] = [
      (
        "bitcoin:mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p", "mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p", nil,
        nil, nil
      ),
      (
        "bitcoin:mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p?message=Luke-Jr",
      ...
      (
        ...
        "mioi9QugUZFSsSm61Gx4u43s6jYkes2L9p", 5_000_000_000, "Donation for project xyz",
        "lntb1500n1pdhdgqjpp5g3rx8txesv7z5pd6pfyp4zqql9lq4cfqvm4d6eve8mwte0d7uydsdpa2fjkzep6yp8hq6twd9hkugz9v35hgmmjd9skcw3qgde8jur5dus9wmmvwejhxcqzysqwez4c6m2070ltq2mfz3ffc5chvwwq6q7tec2pmauths5wpng8ny24aq8gqtuj4w9jmprqt4y50ux27222nkmqfmlkulfr2h6swuqrgpj3ekm4"
      ),
  ...
  func testBitcoinAddress() {
    ...
    for (input, network) in tests {
      ...
      XCTAssertEqual(
        uri?.network, network, "\(input), \(network) = \(String(describing: uri?.network))")
    }
  }
