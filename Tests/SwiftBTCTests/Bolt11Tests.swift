  ...
  func testBolt11Decoding() {
    ...
    let data: [(String, Bolt11.Invoice)] = [
      (
        ...
        Bolt11.Invoice(
          network: .mainnet,
          date: Date(timeIntervalSince1970: 1_496_314_658),
      ...
      (
        ...
        Bolt11.Invoice(
          ...
          description: nil,
          expiry: nil,
          fallbackAddress: BitcoinAddress(
            string: "bc1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qccfmv3")!)
      ),
      (
        ...
        Bolt11.Invoice(
          network: .simnet,
          date: Date(timeIntervalSince1970: 1_562_996_806),
          paymentHash: paymentHash,
          amount: 2000,
          description: nil,
          expiry: 3600,
