...
final class SatoshiFormatterTests: XCTestCase {
  ...
  let inputs: [(Bitcoin, Satoshi, String)] = [
    ...
    (.satoshi, 100, "100"),
    (.satoshi, 1000, "1,000"),
    (.satoshi, 100_000_000, "100,000,000"),
    (.bit, 1, "0.01"),
    (.bit, 123, "1.23"),
    (.bit, 1234, "12.34"),
    (.bit, 123_456_789, "1,234,567.89"),
    (.milliBitcoin, 1, "0.00001"),
    (.milliBitcoin, 123, "0.00123"),
    (.milliBitcoin, 1234, "0.01234"),
    (.milliBitcoin, 100000, "1.0"),
    (.milliBitcoin, 123_456_789, "1,234.56789"),
    (.bitcoin, 1, "0.00000001"),
    (.bitcoin, 100, "0.000001"),
    (.bitcoin, 123_456_000, "1.23456"),
    (.bitcoin, 123_456_789, "1.23456789"),
    (.bitcoin, 100_000_000, "1.0"),
    (.bitcoin, 100_000_000_000, "1,000.0"),
    (.bitcoin, 100_000_000_008, "1,000.00000008"),
  ]
  ...
  func testSatoshiParsing() {
    for (unit, satoshis, string) in inputs {
      ...
      formatter.includeCurrencySymbol = false
      XCTAssertEqual(
        formatter.satoshis(from: string), satoshis, "(\(unit), \(satoshis), \(string))")
    }
  }
  ...
  func testWithoutCommas() {
    let noCommas: [(Bitcoin, Satoshi, String)] = [
      (.satoshi, 1000, "1000"),
      (.bit, 123_456_789, "1234567.89"),
      (.milliBitcoin, 123_456_789, "1234.56789"),
      (.bitcoin, 100_000_000_000, "1000.0"),
      (.bitcoin, 100_000_000_008, "1000.00000008"),
    ]
